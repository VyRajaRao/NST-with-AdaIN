...
def parse_arguments():
    ...
    parser.add_argument("--content_dir", type=str, default="C:/23R21A05CD/AIML class/AI Projects/Neural Style Transfer with AdaIN/content_data",
                        help="Location of the content dataset")
    parser.add_argument("--style_dir", type=str, default="C:/23R21A05CD/AIML class/AI Projects/Neural Style Transfer with AdaIN/style_data",
                        help="Location of the style dataset")
    parser.add_argument("--vgg", type=str, default="C:/23R21A05CD/AIML class/AI Projects/Neural Style Transfer with AdaIN/vgg_normalised.pth",
    ...
    parser.add_argument("--optimizer_path", type=str, default=None,
                        help="Path to the optimizer checkpoint")
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        for content_batch, style_batch in progress_bar:
            ...
            tqdm.write(f"{content_batch.shape} {style_batch.shape}")
        ...
        if (epoch + 1) % args.log_interval == 0:
            tqdm.write(f"Iter {epoch+1}/{args.epochs}, Loss: {running_loss:.4f}, Content Loss: {running_closs:.4f}, Style Loss: {running_sloss:.4f}")
